...
- [Ways to make 2 threads execute by turns in Java](https://github.com/janwee-sha/my-posts/blob/main/Java/Ways.to.make.2.threads.execute.by.turns.in.Java.md)
- [Build a CI/CD pipeline with GitHub, Docker, and Jenkins](https://github.com/janwee-sha/my-posts/blob/main/my-posts/SystemDesign/Building.a.CI.CD.Pipeline.Using.Jenkins.Docker.and.Jenkins.md)
- [Using Nginx as a Load Balancer of MySQL](https://github.com/janwee-sha/my-posts/blob/main/my-posts/SystemDesign/Using.nginx.as.a.TCP.load.balancer.of.MySQL.md)
